...
let i = document.querySelector(".ifra")
...
var a_per = 0;
var a_card = document.querySelector(".cards");
var a_lbtn = document.getElementById("#left-btn");
var a_rbtn = document.querySelector("#right-btn");

function car(){
    a_per+=10;
    if(a_per>0){a_per=0;}
    a_card.style.transform=`translate(${a_per}%)`
    a_card.style.transition="all ease 0.6s"
}

function cars(){
    a_per-=10;
    if(a_per<-50){a_per=-50;}
    a_card.style.transform=`translate(${a_per}%)`;
    a_card.style.transition="all ease 0.6s"
}
